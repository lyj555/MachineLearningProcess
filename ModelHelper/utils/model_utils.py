...
def cross_validation_score(train, y, k_fold, model, model_param=None, return_model_train_time=False, **kwargs):
    t1 = datetime.now()
...
def valid_set_score(train_x, train_y, valid_x, valid_y, model, metric_func, model_param=None,
